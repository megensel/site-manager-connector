...
define( 'SITE_MANAGER_CONNECTOR_VERSION', '1.1.0' );
...
require_once SITE_MANAGER_CONNECTOR_PLUGIN_DIR . 'includes/class-updater.php';
...
add_action( 'init', array( 'Site_Manager_Connector_Updater', 'init' ) );
